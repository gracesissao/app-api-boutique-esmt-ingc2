    ...
    return Scaffold( // on peut remplacer scaffold par safearea pour éviter de cacher les icones qui sont en haut de la page 
      ...
      body: Center(
        ...
        child: SafeArea(child: Container(
          ...
          width: MediaQuery.of(context).size.width,// MediaQuery pour récupérer la taille de l'écran (largeur)
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: (){
          ...
          setState(() { // pour dire à la méthode build de se reconstruire, de redessiner la page 
            _compteur ++;
          });
